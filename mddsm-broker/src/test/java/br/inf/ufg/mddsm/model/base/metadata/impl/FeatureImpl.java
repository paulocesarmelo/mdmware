 ...
 * </p>
 * <ul>
 *   <li>{@link base.metadata.impl.FeatureImpl#getName <em>Name</em>}</li>
 *   <li>{@link base.metadata.impl.FeatureImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link base.metadata.impl.FeatureImpl#getSubFeatures <em>Sub Features</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureImpl extends EObjectImpl implements Feature {
	...
	protected EClass eStaticClass() {
		return MetadataPackageImpl.Literals.FEATURE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetadataPackageImpl.FEATURE__NAME, oldName, name));
	}
	...
	public List<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this,
					MetadataPackageImpl.FEATURE__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public List<Feature> getSubFeatures() {
		if (subFeatures == null) {
			subFeatures = new EObjectContainmentEList<Feature>(Feature.class, this,
					MetadataPackageImpl.FEATURE__SUB_FEATURES);
		}
		return subFeatures;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case MetadataPackageImpl.FEATURE__ATTRIBUTES:
			return ((InternalEList<?>) getAttributes()).basicRemove(otherEnd, msgs);
		case MetadataPackageImpl.FEATURE__SUB_FEATURES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MetadataPackageImpl.FEATURE__NAME:
			return getName();
		case MetadataPackageImpl.FEATURE__ATTRIBUTES:
