...
public class MetadataFactoryImpl extends EFactoryImpl implements MetadataFactory {
	...
	public static MetadataFactoryImpl init() {
		try {
			MetadataFactoryImpl theMetadataFactory = (MetadataFactoryImpl) EPackage.Registry.INSTANCE
					.getEFactory(MetadataPackageImpl.eNS_URI);
	 ...
	 * @generated
	 */
	public MetadataPackageImpl getMetadataPackage() {
