 ...
 * @generated
 */
public class PolicyEvaluationImpl extends EObjectImpl implements PolicyEvaluation {
	/**
	...
	protected EClass eStaticClass() {
		return PolicyPackageImpl.Literals.POLICY_EVALUATION;
	}
	...
	public NotificationChain basicSetFeature(Value newFeature, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PolicyPackageImpl.POLICY_EVALUATION__FEATURE, oldFeature, newFeature);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newFeature != feature) {
			...
			if (feature != null)
				msgs = ((InternalEObject) feature).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - PolicyPackageImpl.POLICY_EVALUATION__FEATURE, null, msgs);
			if (newFeature != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PolicyPackageImpl.POLICY_EVALUATION__FEATURE,
	...
	public List<ParameterBinding> getContextBinding() {
		if (contextBinding == null) {
			contextBinding = new EObjectContainmentEList<ParameterBinding>(ParameterBinding.class, this,
					PolicyPackageImpl.POLICY_EVALUATION__CONTEXT_BINDING);
		}
	...
	public NotificationChain basicSetContext(PolicyEvaluationContext newContext, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PolicyPackageImpl.POLICY_EVALUATION__CONTEXT, oldContext, newContext);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newContext != context) {
			...
			if (context != null)
				msgs = ((InternalEObject) context).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - PolicyPackageImpl.POLICY_EVALUATION__CONTEXT, null, msgs);
			if (newContext != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PolicyPackageImpl.POLICY_EVALUATION__CONTEXT,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PolicyPackageImpl.POLICY_EVALUATION__FEATURE:
			return basicSetFeature(null, msgs);
		case PolicyPackageImpl.POLICY_EVALUATION__CONTEXT_BINDING:
			return ((InternalEList<?>) getContextBinding()).basicRemove(otherEnd, msgs);
		case PolicyPackageImpl.POLICY_EVALUATION__CONTEXT:
