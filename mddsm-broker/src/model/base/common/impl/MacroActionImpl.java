 ...
 * </p>
 * <ul>
 *   <li>{@link base.common.impl.MacroActionImpl#getImpl <em>Impl</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MacroActionImpl extends ActionImpl implements MacroAction {
	...
	protected EClass eStaticClass() {
		return CommonPackageImpl.Literals.MACRO_ACTION;
	}
	...
	public void setImpl(String newImpl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonPackageImpl.MACRO_ACTION__IMPL, oldImpl, impl));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CommonPackageImpl.MACRO_ACTION__IMPL:
			return getImpl();
		}
