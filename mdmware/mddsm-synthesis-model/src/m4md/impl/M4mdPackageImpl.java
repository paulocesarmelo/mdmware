...
import nml.NmlPackage;
import nml.impl.NmlPackageImpl;
...
public class M4mdPackageImpl extends EPackageImpl implements M4mdPackage {
	...
	public static M4mdPackage init() {
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(NmlPackage.eNS_URI);
		NmlPackageImpl theNmlPackage = (NmlPackageImpl)(registeredPackage instanceof NmlPackageImpl ? registeredPackage : NmlPackage.eINSTANCE);
