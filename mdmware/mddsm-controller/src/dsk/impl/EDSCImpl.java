...
public class EDSCImpl extends MinimalEObjectImpl.Container implements EDSC {
	 ...
	 * @ordered
	 */
	protected EDomainSpecificEntity entity;
	 ...
	 */
	@Override
	public EDomainSpecificEntity getEntity() {
		if (entity != null && entity.eIsProxy()) {
			InternalEObject oldEntity = (InternalEObject)entity;
			entity = (EDomainSpecificEntity)eResolveProxy(oldEntity);
			if (entity != oldEntity) {
				if (eNotificationRequired())
	 ...
	 * @generated
	 */
	public EDomainSpecificEntity basicGetEntity() {
		return entity;
	}
	 ...
	 */
	@Override
	public void setEntity(EDomainSpecificEntity newEntity) {
		EDomainSpecificEntity oldEntity = entity;
		entity = newEntity;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DskPackage.EDSC__PARAMETERS:
				...
				return;
			case DskPackage.EDSC__ENTITY:
				setEntity((EDomainSpecificEntity)newValue);
				return;
			case DskPackage.EDSC__CONDITION:
				getCondition().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case DskPackage.EDSC__PARAMETERS:
				...
				return;
			case DskPackage.EDSC__ENTITY:
				setEntity((EDomainSpecificEntity)null);
				return;
			case DskPackage.EDSC__CONDITION:
				getCondition().clear();
				return;
