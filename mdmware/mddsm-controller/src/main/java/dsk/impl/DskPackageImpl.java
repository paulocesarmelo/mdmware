...
public class DskPackageImpl extends EPackageImpl implements DskPackage {
	 ...
	 * @generated
	 */
	private EEnum eMetaCmdTypeEEnum = null;
	 ...
	 * @generated
	 */
	public EAttribute getEDSEvent_MetaCmd() {
		return (EAttribute)edsEventEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EEnum getEMetaCmdType() {
		return eMetaCmdTypeEEnum;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(edsEventEClass, EDS_EVENT__META_CMD);
		...
		eMetaCmdTypeEEnum = createEEnum(EMETA_CMD_TYPE);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getEDSC_Entity(), this.getEDSEntity(), null, "entity", null, 1, 1, dsk.EDSC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEDSEvent_MetaCmd(), this.getEMetaCmdType(), "metaCmd", "NONE", 0, 1, EDSEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(eMetaCmdTypeEEnum, EMetaCmdType.class, "EMetaCmdType");
		addEEnumLiteral(eMetaCmdTypeEEnum, EMetaCmdType.NONE);
		addEEnumLiteral(eMetaCmdTypeEEnum, EMetaCmdType.ADD);
		addEEnumLiteral(eMetaCmdTypeEEnum, EMetaCmdType.DELETE);
		addEEnumLiteral(eMetaCmdTypeEEnum, EMetaCmdType.CHANGE);
		addEEnumLiteral(eMetaCmdTypeEEnum, EMetaCmdType.MOVE);
