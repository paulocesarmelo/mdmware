...
public class HandlerImpl extends MinimalEObjectImpl.Container implements Handler {
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.HANDLER;
	}
	...
	public void setSignal(Signal newSignal) {
		...
		signal = newSignal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.HANDLER__SIGNAL, oldSignal, signal));
	}
	...
	public void setEnabled(boolean newEnabled) {
		...
		enabled = newEnabled;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.HANDLER__ENABLED, oldEnabled, enabled));
	}
