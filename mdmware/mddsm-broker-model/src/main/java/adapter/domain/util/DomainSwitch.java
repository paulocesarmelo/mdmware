...
public class DomainSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DomainPackage.DS_ENTITY: {
				DSEntity dsEntity = (DSEntity)theEObject;
				T result = caseDSEntity(dsEntity);
				if (result == null) result = caseEDSEntity(dsEntity);
				if (result == null) result = caseEDomainSpecificEntity(dsEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DomainPackage.DOMAIN_ELEMENTS: {
				DomainElements domainElements = (DomainElements)theEObject;
				T result = caseDomainElements(domainElements);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>DS Entity</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>DS Entity</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDSEntity(DSEntity object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseDomainElements(DomainElements object) {
		return null;
	}
