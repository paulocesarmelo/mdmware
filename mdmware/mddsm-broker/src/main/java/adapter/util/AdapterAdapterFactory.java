...
public class AdapterAdapterFactory extends AdapterFactoryImpl {
	...
	protected AdapterSwitch<Adapter> modelSwitch =
		new AdapterSwitch<Adapter>() {
			@Override
			public Adapter caseAdapter(adapter.Adapter object) {
			...
			@Override
			public Adapter caseDispatcher(Dispatcher object) {
				return createDispatcherAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link adapter.Adapter <em>Adapter</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link adapter.Mapper <em>Mapper</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link adapter.Function <em>Function</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link adapter.Dispatcher <em>Dispatcher</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDispatcherAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link adapter.Components <em>Components</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
