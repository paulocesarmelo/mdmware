...
public class DomainAdapterFactory extends AdapterFactoryImpl {
	...
	protected DomainSwitch<Adapter> modelSwitch =
		new DomainSwitch<Adapter>() {
			@Override
			public Adapter caseDSEntity(DSEntity object) {
				return createDSEntityAdapter();
			}
			@Override
			public Adapter caseDomainElements(DomainElements object) {
				return createDomainElementsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link adapter.domain.DSEntity <em>DS Entity</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDSEntityAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link adapter.domain.DomainElements <em>Elements</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDomainElementsAdapter() {
		return null;
	}
