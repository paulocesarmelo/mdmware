...
import testing2.impl.Testing2PackageImpl;
...
public class M4mdPackageImpl extends EPackageImpl implements M4mdPackage {
	...
	public static M4mdPackage init() {
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(Testing2Package.eNS_URI);
		Testing2PackageImpl theTesting2Package = (Testing2PackageImpl)(registeredPackage instanceof Testing2PackageImpl ? registeredPackage : Testing2Package.eINSTANCE);
