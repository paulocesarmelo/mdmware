 ...
 * </p>
 * <ul>
 *   <li>{@link testing2.impl.ClassActorImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassActorImpl extends EActorImpl implements ClassActor {
	...
	protected EClass eStaticClass() {
		return Testing2Package.Literals.CLASS_ACTOR;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Testing2Package.CLASS_ACTOR__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Testing2Package.CLASS_ACTOR__NAME:
				return getName();
		}
