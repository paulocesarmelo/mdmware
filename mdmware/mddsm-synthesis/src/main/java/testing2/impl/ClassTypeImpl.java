 ...
 * </p>
 * <ul>
 *   <li>{@link testing2.impl.ClassTypeImpl#getTypeName <em>Type Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassTypeImpl extends EDomainSpecificTypeImpl implements ClassType {
	...
	protected EClass eStaticClass() {
		return Testing2Package.Literals.CLASS_TYPE;
	}
	...
	public void setTypeName(String newTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Testing2Package.CLASS_TYPE__TYPE_NAME, oldTypeName, typeName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Testing2Package.CLASS_TYPE__TYPE_NAME:
				return getTypeName();
		}
