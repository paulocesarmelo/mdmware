...
import metalang4md.impl.EItemImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link testing.impl.ClassItemImpl#getAttrInt <em>Attr Int</em>}</li>
 *   <li>{@link testing.impl.ClassItemImpl#getAttrString <em>Attr String</em>}</li>
 *   <li>{@link testing.impl.ClassItemImpl#getByReferences <em>By References</em>}</li>
 *   <li>{@link testing.impl.ClassItemImpl#getByComposition <em>By Composition</em>}</li>
 *   <li>{@link testing.impl.ClassItemImpl#getCmd <em>Cmd</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassItemImpl extends EItemImpl implements ClassItem {
	/**
	...
	protected EClass eStaticClass() {
		return TestingPackage.Literals.CLASS_ITEM;
	}
	...
	public void setAttrInt(int newAttrInt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestingPackage.CLASS_ITEM__ATTR_INT, oldAttrInt, attrInt));
	}
	...
	public void setAttrString(String newAttrString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestingPackage.CLASS_ITEM__ATTR_STRING, oldAttrString, attrString));
	}
	...
	public EList<EObject> getByReferences() {
		if (byReferences == null) {
			byReferences = new EObjectResolvingEList<EObject>(EObject.class, this, TestingPackage.CLASS_ITEM__BY_REFERENCES);
		}
		return byReferences;
	}
	...
	public EList<EObject> getByComposition() {
		if (byComposition == null) {
			byComposition = new EObjectContainmentEList<EObject>(EObject.class, this, TestingPackage.CLASS_ITEM__BY_COMPOSITION);
		}
	...
	public EList<CmdType> getCmd() {
		if (cmd == null) {
			cmd = new EDataTypeUniqueEList<CmdType>(CmdType.class, this, TestingPackage.CLASS_ITEM__CMD);
		}
		return cmd;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TestingPackage.CLASS_ITEM__BY_COMPOSITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestingPackage.CLASS_ITEM__ATTR_INT:
				return getAttrInt();
			case TestingPackage.CLASS_ITEM__ATTR_STRING:
				return getAttrString();
			case TestingPackage.CLASS_ITEM__BY_REFERENCES:
				return getByReferences();
			case TestingPackage.CLASS_ITEM__BY_COMPOSITION:
				return getByComposition();
			case TestingPackage.CLASS_ITEM__CMD:
				return getCmd();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BaseClass.class) {
			switch (derivedFeatureID) {
				case TestingPackage.CLASS_ITEM__ATTR_INT: return TestingPackage.BASE_CLASS__ATTR_INT;
				case TestingPackage.CLASS_ITEM__ATTR_STRING: return TestingPackage.BASE_CLASS__ATTR_STRING;
				case TestingPackage.CLASS_ITEM__BY_REFERENCES: return TestingPackage.BASE_CLASS__BY_REFERENCES;
				case TestingPackage.CLASS_ITEM__BY_COMPOSITION: return TestingPackage.BASE_CLASS__BY_COMPOSITION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == BaseClass.class) {
			switch (baseFeatureID) {
				case TestingPackage.BASE_CLASS__ATTR_INT: return TestingPackage.CLASS_ITEM__ATTR_INT;
				case TestingPackage.BASE_CLASS__ATTR_STRING: return TestingPackage.CLASS_ITEM__ATTR_STRING;
				case TestingPackage.BASE_CLASS__BY_REFERENCES: return TestingPackage.CLASS_ITEM__BY_REFERENCES;
				case TestingPackage.BASE_CLASS__BY_COMPOSITION: return TestingPackage.CLASS_ITEM__BY_COMPOSITION;
				default: return -1;
			}
		}
