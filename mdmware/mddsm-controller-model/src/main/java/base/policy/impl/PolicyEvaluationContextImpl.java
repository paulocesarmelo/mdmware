 ...
 * @generated
 */
public class PolicyEvaluationContextImpl extends MinimalEObjectImpl.Container implements PolicyEvaluationContext {
	/**
	...
	protected EClass eStaticClass() {
		return PolicyPackage.Literals.POLICY_EVALUATION_CONTEXT;
	}
