...
public class Class_
{
  ...
  protected final String TEXT_507 = NL + "\t\t\tdefault:";
  protected final String TEXT_508 = "\t\treturn super.eInverseAdd(otherEnd, featureID, msgs);";
  protected final String TEXT_509 = "\t\treturn eDynamicInverseAdd(otherEnd, featureID, msgs);";
  protected final String TEXT_510 = " eInverseRemove(";
  protected final String TEXT_511 = "()).eMap()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_512 = ".Internal.Wrapper)";
  protected final String TEXT_513 = "()).featureMap()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_514 = "()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_515 = NL + "\t\t\t\treturn eBasicSetContainer(null, ";
  protected final String TEXT_516 = NL + "\t\t\t\treturn basicUnset";
  protected final String TEXT_517 = "(msgs);";
  protected final String TEXT_518 = "(null, msgs);";
  protected final String TEXT_519 = "\t\treturn super.eInverseRemove(otherEnd, featureID, msgs);";
  protected final String TEXT_520 = "\t\treturn eDynamicInverseRemove(otherEnd, featureID, msgs);";
  protected final String TEXT_521 = " eBasicRemoveFromContainerFeature(";
  protected final String TEXT_522 = " msgs)" + NL + "\t{" + NL + "\t\tswitch (eContainerFeatureID()";
  protected final String TEXT_523 = ":" + NL + "\t\t\t\treturn eInternalContainer().eInverseRemove(this, ";
  protected final String TEXT_524 = "\t\treturn super.eBasicRemoveFromContainerFeature(msgs);";
  protected final String TEXT_525 = "\t\treturn eDynamicBasicRemoveFromContainer(msgs);";
  protected final String TEXT_526 = NL + "\tpublic Object eGet(int featureID, boolean resolve, boolean coreType)" + NL + "\t{" + NL + "\t\tswitch (featureID";
  protected final String TEXT_527 = NL + "\t\t\t\treturn ";
  protected final String TEXT_528 = "() ? Boolean.TRUE : Boolean.FALSE;";
  protected final String TEXT_529 = NL + "\t\t\t\treturn new ";
  protected final String TEXT_530 = "());";
  protected final String TEXT_531 = NL + "\t\t\t\tif (resolve) return ";
  protected final String TEXT_532 = "();" + NL + "\t\t\t\treturn basicGet";
  protected final String TEXT_533 = NL + "\t\t\t\tif (coreType) return ((";
  protected final String TEXT_534 = "()).eMap();" + NL + "\t\t\t\telse return ";
  protected final String TEXT_535 = NL + "\t\t\t\tif (coreType) return ";
  protected final String TEXT_536 = "();" + NL + "\t\t\t\telse return ";
  protected final String TEXT_537 = "().map();";
  protected final String TEXT_538 = "()).featureMap();" + NL + "\t\t\t\treturn ";
  protected final String TEXT_539 = "();" + NL + "\t\t\t\treturn ((";
  protected final String TEXT_540 = "()).getWrapper();";
  protected final String TEXT_541 = "\t\treturn super.eGet(featureID, resolve, coreType);";
  protected final String TEXT_542 = "\t\treturn eDynamicGet(featureID, resolve, coreType);";
  protected final String TEXT_543 = NL + "\tpublic void eSet(int featureID, Object newValue)" + NL + "\t{" + NL + "\t\tswitch (featureID";
  protected final String TEXT_544 = NL + "\t\t\t\t((";
  protected final String TEXT_545 = "()).featureMap()).set(newValue);";
  protected final String TEXT_546 = "()).set(newValue);";
  protected final String TEXT_547 = ".Setting)((";
  protected final String TEXT_548 = "()).eMap()).set(newValue);";
  protected final String TEXT_549 = ".Setting)";
  protected final String TEXT_550 = "().clear();" + NL + "\t\t\t\t";
  protected final String TEXT_551 = "().addAll((";
  protected final String TEXT_552 = "<? extends ";
  protected final String TEXT_553 = ">";
  protected final String TEXT_554 = ")newValue);";
  protected final String TEXT_555 = NL + "\t\t\t\tset";
  ...
  protected final String TEXT_560 = "\t\tsuper.eSet(featureID, newValue);";
  protected final String TEXT_561 = "\t\teDynamicSet(featureID, newValue);";
  protected final String TEXT_562 = NL + "\tpublic void eUnset(int featureID)" + NL + "\t{" + NL + "\t\tswitch (featureID";
  protected final String TEXT_563 = "()).featureMap().clear();";
  protected final String TEXT_564 = "().clear();";
  protected final String TEXT_565 = NL + "\t\t\t\tunset";
  protected final String TEXT_566 = ")null);";
  protected final String TEXT_567 = "\t\tsuper.eUnset(featureID);";
  protected final String TEXT_568 = "\t\teDynamicUnset(featureID);";
  protected final String TEXT_569 = NL + "\tpublic boolean eIsSet(int featureID)" + NL + "\t{" + NL + "\t\tswitch (featureID";
  protected final String TEXT_570 = NL + "\t\t\t\treturn isSet";
  protected final String TEXT_571 = NL + "\t\t\t\treturn !((";
  protected final String TEXT_572 = "()).featureMap().isEmpty();";
  protected final String TEXT_573 = " != null && !";
  protected final String TEXT_574 = ".featureMap().isEmpty();";
  protected final String TEXT_575 = ".isEmpty();";
  ...
  protected final String TEXT_580 = NL + "\t\t\t\treturn eVirtualGet(";
  protected final String TEXT_581 = ") != null;";
  protected final String TEXT_582 = NL + "\t\t\t\treturn basicGet";
  protected final String TEXT_583 = "() != null;";
  protected final String TEXT_584 = "_EFLAG) != 0) != ";
  protected final String TEXT_585 = "_EFLAG) != ";
  protected final String TEXT_586 = ") != ";
  protected final String TEXT_587 = "() != ";
  protected final String TEXT_588 = " != null : !";
  protected final String TEXT_589 = ".equals(";
  protected final String TEXT_590 = "() != null : !";
  protected final String TEXT_591 = "\t\treturn super.eIsSet(featureID);";
  protected final String TEXT_592 = "\t\treturn eDynamicIsSet(featureID);";
  protected final String TEXT_593 = NL + "\tpublic int eBaseStructuralFeatureID(int derivedFeatureID, Class";
  protected final String TEXT_594 = " baseClass)" + NL + "\t{";
  protected final String TEXT_595 = NL + "\t\tif (baseClass == ";
  protected final String TEXT_596 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (derivedFeatureID";
  protected final String TEXT_597 = NL + "\t\t\t\tcase ";
  protected final String TEXT_598 = ": return ";
  protected final String TEXT_599 = NL + "\t\t\t\tdefault: return -1;" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_600 = NL + "\t\treturn super.eBaseStructuralFeatureID(derivedFeatureID, baseClass);" + NL + "\t}";
  protected final String TEXT_601 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_602 = NL + "\tpublic int eDerivedStructuralFeatureID(int baseFeatureID, Class";
  protected final String TEXT_603 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseFeatureID)" + NL + "\t\t\t{";
  protected final String TEXT_604 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseFeatureID";
  protected final String TEXT_605 = NL + "\t\treturn super.eDerivedStructuralFeatureID(baseFeatureID, baseClass);" + NL + "\t}" + NL;
  protected final String TEXT_606 = NL + "\tpublic int eDerivedOperationID(int baseOperationID, Class";
  protected final String TEXT_607 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseOperationID)" + NL + "\t\t\t{";
  protected final String TEXT_608 = NL + "\t\t\t\tdefault: return super.eDerivedOperationID(baseOperationID, baseClass);" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_609 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseOperationID";
  protected final String TEXT_610 = NL + "\t\treturn super.eDerivedOperationID(baseOperationID, baseClass);" + NL + "\t}" + NL;
  protected final String TEXT_611 = NL + "\tprotected Object[] eVirtualValues()" + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_612 = ";" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_613 = NL + "\tprotected void eSetVirtualValues(Object[] newValues)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_614 = " = newValues;" + NL + "\t}" + NL;
  protected final String TEXT_615 = NL + "\tprotected int eVirtualIndexBits(int offset)" + NL + "\t{" + NL + "\t\tswitch (offset)" + NL + "\t\t{";
  protected final String TEXT_616 = " :" + NL + "\t\t\t\treturn ";
  protected final String TEXT_617 = NL + "\t\t\tdefault :" + NL + "\t\t\t\tthrow new IndexOutOfBoundsException();" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_618 = NL + "\tprotected void eSetVirtualIndexBits(int offset, int newIndexBits)" + NL + "\t{" + NL + "\t\tswitch (offset)" + NL + "\t\t{";
  protected final String TEXT_619 = " :" + NL + "\t\t\t\t";
  protected final String TEXT_620 = " = newIndexBits;" + NL + "\t\t\t\tbreak;";
  protected final String TEXT_621 = NL + "\t\t\tdefault :" + NL + "\t\t\t\tthrow new IndexOutOfBoundsException();" + NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_622 = NL + "\t@SuppressWarnings(";
  protected final String TEXT_623 = "\"unchecked\"";
  protected final String TEXT_624 = "{\"rawtypes\", \"unchecked\" }";
  protected final String TEXT_625 = NL + "\tpublic Object eInvoke(int operationID, ";
  protected final String TEXT_626 = " arguments) throws ";
  protected final String TEXT_627 = NL + "\t{" + NL + "\t\tswitch (operationID";
  protected final String TEXT_628 = NL + "\t\t\t\ttry" + NL + "\t\t\t\t{";
  protected final String TEXT_629 = "arguments.get(";
  protected final String TEXT_630 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_631 = "return null;";
  protected final String TEXT_632 = "return ";
  protected final String TEXT_633 = NL + "\t\t\t\t}" + NL + "\t\t\t\tcatch (";
  protected final String TEXT_634 = " throwable)" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tthrow new ";
  protected final String TEXT_635 = "(throwable);" + NL + "\t\t\t\t}";
  protected final String TEXT_636 = "\t\treturn super.eInvoke(operationID, arguments);";
  protected final String TEXT_637 = "\t\treturn eDynamicInvoke(operationID, arguments);";
  protected final String TEXT_638 = NL + "\tpublic String toString()" + NL + "\t{" + NL + "\t\tif (eIsProxy()) return super.toString();" + NL + "" + NL + "\t\t";
  protected final String TEXT_639 = " result = new ";
  protected final String TEXT_640 = "(super.toString());";
  protected final String TEXT_641 = NL + "\t\tresult.append(\" (";
  protected final String TEXT_642 = ": \");";
  protected final String TEXT_643 = NL + "\t\tresult.append(\", ";
  protected final String TEXT_644 = NL + "\t\tif (eVirtualIsSet(";
  protected final String TEXT_645 = ")) result.append(eVirtualGet(";
  protected final String TEXT_646 = ")); else result.append(\"<unset>\");";
  protected final String TEXT_647 = "_ESETFLAG) != 0";
  protected final String TEXT_648 = ") result.append((";
  protected final String TEXT_649 = "_EFLAG) != 0); else result.append(\"<unset>\");";
  protected final String TEXT_650 = ") result.append(";
  protected final String TEXT_651 = "_EFLAG_OFFSET]); else result.append(\"<unset>\");";
  protected final String TEXT_652 = "); else result.append(\"<unset>\");";
  protected final String TEXT_653 = NL + "\t\tresult.append(eVirtualGet(";
  ...
  protected final String TEXT_657 = "_EFLAG_OFFSET]);";
  protected final String TEXT_658 = NL + "\t\tresult.append(')');" + NL + "\t\treturn result.toString();" + NL + "\t}" + NL;
  protected final String TEXT_659 = NL + "\tprotected int hash = -1;" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_660 = NL + "\tpublic int getHash()" + NL + "\t{" + NL + "\t\tif (hash == -1)" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_661 = " theKey = getKey();" + NL + "\t\t\thash = (theKey == null ? 0 : theKey.hashCode());" + NL + "\t\t}" + NL + "\t\treturn hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_662 = NL + "\tpublic void setHash(int hash)" + NL + "\t{" + NL + "\t\tthis.hash = hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_666 = NL + "\tpublic void setKey(";
  ...
  protected final String TEXT_675 = " getValue()" + NL + "\t{";
  protected final String TEXT_676 = "(getTypedValue());";
  protected final String TEXT_677 = NL + "\t\treturn getTypedValue();";
  protected final String TEXT_678 = " setValue(";
  protected final String TEXT_679 = " value)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_680 = " oldValue = getValue();";
  protected final String TEXT_681 = NL + "\t\tgetTypedValue().clear();" + NL + "\t\tgetTypedValue().addAll(";
  protected final String TEXT_682 = "value);";
  protected final String TEXT_683 = NL + "\t\tsetTypedValue(value);";
  protected final String TEXT_684 = NL + "\t\tsetTypedValue(((";
  ...
  protected final String TEXT_688 = NL + "\t\treturn oldValue;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_689 = " getEMap()" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_690 = " container = eContainer();" + NL + "\t\treturn container == null ? null : (";
  protected final String TEXT_691 = ")container.eGet(eContainmentFeature());" + NL + "\t}" + NL;
