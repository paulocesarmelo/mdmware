 ...
 * </p>
 * <ul>
 *   <li>{@link iscadapter.resources.impl.LocationImpl#getLat <em>Lat</em>}</li>
 *   <li>{@link iscadapter.resources.impl.LocationImpl#getLong <em>Long</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocationImpl extends MinimalEObjectImpl.Container implements Location {
	...
	protected EClass eStaticClass() {
		return ResourcesPackage.Literals.LOCATION;
	}
	...
	public void setLat(double newLat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.LOCATION__LAT, oldLat, lat));
	}
	...
	public void setLong(double newLong) {
		...
		long_ = newLong;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcesPackage.LOCATION__LONG, oldLong, long_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResourcesPackage.LOCATION__LAT:
				return getLat();
			case ResourcesPackage.LOCATION__LONG:
				return getLong();
		}
