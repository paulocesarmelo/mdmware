...
public class ComponentsFactoryImpl extends EFactoryImpl implements ComponentsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ComponentsPackage.RESOURCE_DISCOVERY: return createResourceDiscovery();
			case ComponentsPackage.DATA_COLLECTOR: return createDataCollector();
			case ComponentsPackage.ACTUATOR_CONTROLLER: return createActuatorController();
			default:
	...
	public ResourceDiscovery createResourceDiscovery() {
		ResourceDiscoveryImpl resourceDiscovery = new ResourceDiscoveryImpl();
	 ...
	 * @generated
	 */
	public ActuatorController createActuatorController() {
		ActuatorControllerImpl actuatorController = new ActuatorControllerImpl();
