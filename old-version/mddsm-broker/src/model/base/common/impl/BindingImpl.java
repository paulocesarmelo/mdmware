...
public class BindingImpl extends EObjectImpl implements Binding {
	...
	protected EClass eStaticClass() {
		return CommonPackageImpl.Literals.BINDING;
	}
		...
		if (bindable != null && bindable.eIsProxy()) {
			...
			if (bindable != oldBindable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CommonPackageImpl.BINDING__BINDABLE,
	...
	public void setBindable(Bindable newBindable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonPackageImpl.BINDING__BINDABLE, oldBindable,
					bindable));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonPackageImpl.BINDING__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CommonPackageImpl.BINDING__BINDABLE:
			if (resolve)
				return getBindable();
			return basicGetBindable();
		case CommonPackageImpl.BINDING__NAME:
			return getName();
		}
