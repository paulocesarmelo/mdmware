...
class CloseDevice implements MacroActionInstance {
	...
	public Object execute(ManagerContext ctx, Map<String, Object> params) {
		...
		dev.open = false
		println ">>>closing dev"
		Util.bottom_mhb_log "CloseDevice", params ,state
		
		if(dev.resource.execute(new SignalInstance("closeDev", params)))
		{
