 ...
 * @generated
 */
public class PolicyEvaluationRequestImpl extends MinimalEObjectImpl.Container implements PolicyEvaluationRequest {
	/**
	...
	protected EClass eStaticClass() {
		return PolicyPackage.Literals.POLICY_EVALUATION_REQUEST;
	}
